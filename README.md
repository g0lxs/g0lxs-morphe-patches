...
> **Nota:** A modificação re-assina o APK com uma chave local, portanto o login padrão com conta Google para de funcionar; utilize login por e-mail diretamente no aplicativo. Backups e sincronização na nuvem dependem dos servidores do Ilqfk e não são cobertos.
