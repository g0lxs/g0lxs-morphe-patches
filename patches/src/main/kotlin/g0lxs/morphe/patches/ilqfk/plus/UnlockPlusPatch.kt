...
private val ILQFK_VERSIONS = listOf("3.73.204", "3.73.202")
...
private val versionSignatures = listOf(
    // Ilqfk 3.73.204 (lib/arm64-v8a/libapp.so)
    VersionSignatures(
        version = "3.73.204",
        isUserSubscribedSig = byteArrayOf(
            ...
            0x00.toByte(), 0x9c.toByte(), 0x52.toByte(), 0xf9.toByte(),
            ...
            0x62.toByte(), 0x2b.toByte(), 0x7d.toByte(), 0xf9.toByte(),
            0x13.toByte(), 0x13.toByte(), 0x59.toByte(), 0x94.toByte(),
            0x70.toByte(), 0x27.toByte(), 0x40.toByte(), 0x91.toByte(),
            0x10.toByte(), 0xea.toByte(), 0x41.toByte(), 0xf9.toByte(),
        ),
        getStateSig = byteArrayOf(
            ...
            0x20.toByte(), 0x0c.toByte(), 0xfb.toByte(), 0x97.toByte(),
            ...
            0x10.toByte(), 0x26.toByte(), 0x45.toByte(), 0xf9.toByte(),
        ),
    ),
...
val unlockPlusPatch = rawResourcePatch(
    ...
    compatibleWith(
        Compatibility(
            ...
            targets = ILQFK_VERSIONS.map(::AppTarget),
        ),
    )
        ...
        if (matchedVersion == null || isSubMatchPos == null || stateMatchPos == null) {
            throw PatchException(
                "Ilqfk Plus: Unsupported Ilqfk version. Supported versions: " +
                    ILQFK_VERSIONS.joinToString(", ") + ". Please use a supported APK.",
            )
        }
